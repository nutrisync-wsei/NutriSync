    ...
    const value = useMemo(
        () => ({
            ...
            isBreakpointActive: (breakpoint: Breakpoint): boolean => {
                ...
                const breakpointMinWidth = breakpointValues[breakpoint as keyof typeof breakpointValues];
                const currentBreakpointMinWidth = breakpointValues[currentBreakpoint as keyof typeof breakpointValues];
